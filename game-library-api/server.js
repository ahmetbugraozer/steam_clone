...
app.get('/api/games/most-wishlisted', async (req, res) => {
  try {
    ...
    const result = await pool.request()
      ...
      .query(`
        SELECT TOP (@limit)
          o.*, g.GelistiriciAdi, y.YayinciAdi, COUNT(i.IstekListesiID) as EklenmeSayisi
        FROM Oyunlar o
        JOIN Gelistiriciler g ON o.GelistiriciID = g.GelistiriciID
        JOIN Yayincilar y ON o.YayinciID = y.YayinciID
        JOIN IstekListesi i ON o.OyunID = i.OyunID
        GROUP BY o.OyunID, o.OyunAdi, o.Aciklama, o.CikisTarihi, o.Fiyat, o.KapakGorseliURL, 
